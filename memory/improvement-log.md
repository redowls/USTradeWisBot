...
- **Commit:** (filled below)
- **Observed effect:** (pending — re-confirm on the next session with EOD flattens that the recorded entry matches the Alpaca buy fill and the day's DB gross equals the broker equity move.)
