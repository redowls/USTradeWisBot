...
def test_breakeven_ratchet_locks_a_scratch_not_a_full_loss():
    ...
    # 0.5R break-even trigger (IMP-013 geometry, restored by IMP-059) but not the
    # 1.0R trail trigger -> stop moves to entry, 100.00. Bar2 dips to 99.5, so it
    # exits at 100.00 (flat), NOT at the original 99. Confirms the ratchet moved
    # the stop. (Under IMP-040's 0.25R trail this exited at 100.35.)
